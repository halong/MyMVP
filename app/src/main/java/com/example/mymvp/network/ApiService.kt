...
interface ApiService {
    ...
    fun getArticleList(@Path("curPage") curPage: Int): Observable<JsonData<ArticleList>>
     ...
     */
    @GET("banner/json")
    fun getBanner(): Observable<JsonData<List<Banner>>>
     ...
     */
    @GET("friend/json")
    fun getFriend(): Observable<JsonData<List<Friend>>>
     ...
     */
    @GET("hotkey/json")
    fun getHotkey(): Observable<JsonData<List<Hotkey>>>
    ...
    fun getTopArticle(): Observable<JsonData<List<TopArticle>>>
     ...
     */
    @GET("tree/json")
    fun getTree(): Observable<JsonData<Tree>>
    ...
    fun getTreeArticle(
        ...
        @Query("cid") cid: Int
    ): Observable<JsonData<TreeArticleList>>
